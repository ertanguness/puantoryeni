                    ...
                    <table class="table card-table text-nowrap datatable" id="bordroTable">
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%" class="text-center">Net</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($persons as $item):
                                ...
                                $salary = $bordro->getPersonSalaryAndWageCut($person->id, $firstDay, $lastDay)->maas;
                                $gelir = $bordro->getPersonSalaryAndWageCut($person->id, $firstDay, $lastDay)->gelir;
                                $wage_cut = $bordro->getPersonSalaryAndWageCut($person->id, $firstDay, $lastDay)->kesinti;
                                ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo Helper::formattedMoney($salary + $gelir) ?></td>
                                <td class="text-center"><?php echo Helper::formattedMoney($wage_cut); ?></td>
                                <td class="text-center">
                                    <?php echo Helper::formattedMoney($salary + $gelir - $wage_cut); ?></td>
                                <td class="text-end">
                                    <div class="dropdown">
...
<?php echo include_once "content/wage_cut-modal.php"; ?>
<?php echo include_once "content/income-modal.php"; ?>