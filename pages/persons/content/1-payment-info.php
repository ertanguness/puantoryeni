                        ...
                        <div class="dropdown me-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item add-payment" data-bs-toggle="modal"
                                    data-bs-target="#payment-modal" data-tooltip="Personellere Ödeme yapın"
                                    data-tooltip-location="left" data-id="<?php echo $person->id; ?>" href="#">
                                    <i class="ti ti-upload icon me-3"></i> Ödeme Yap
                                </a>
                                <a class="dropdown-item add-income" href="#" data-bs-toggle="modal"
                                    data-bs-target="#income_modal" data-id="<?php echo $person->id; ?>">
                                    <i class="ti ti-download icon me-3"></i> Gelir Ekle
                                </a>
                                <a class="dropdown-item add-wage-cut" href="#" data-bs-toggle="modal"
                                    data-bs-target="#wage_cut_modal" data-id="<?php echo $person->id; ?>">
