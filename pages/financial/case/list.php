                            ...
                            <?php foreach ($cases as $case):
                                ...
                                <tr>
                                    ...
                                    <td> <a class="btn route-link" data-tooltip="Detay/Güncelle"
                                            data-page="financial/transaction/list&id=<?php echo $case->id ?>" href="#">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item route-link"
                                                    data-page="financial/transaction/list&id=<?php echo $case->id ?>"
                                                    href="#">
                                                    <i class="ti ti-transfer icon me-3"></i> Kasa Hareketleri
                                                </a>
                                                <a class="dropdown-item route-link"
                                                    data-page="financial/case/manage&id=<?php echo $case->id ?>" href="#">
                                                    <i class="ti ti-edit icon me-3"></i> Güncelle/Detay
                                                </a>
                                                <a class="dropdown-item default-case" data-id="<?php echo $case->id ?>"
                                                    href="#">
                                                    <i class="ti ti-checks icon me-3"></i> Varsayılan Yap
                                                </a>
                                                <a class="dropdown-item delete-case" data-id="<?php echo $case->id ?>"
                                                    href="#">
