<div class="row mt-3">
    ...
    <div class="col-md-4">
        <input type="text" class="form-control flatpickr" name="start_date" value="<?php echo $project->start_date ?? '' ?>">
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="project" placeholder="Proje hakkında not ekleyebilirsiniz"><?php echo $project->notes ?? '' ?></textarea>
    </div>
</div>